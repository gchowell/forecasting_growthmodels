...
for i=tstart1:1:tend1-windowsize1+1  %rolling window analysis
    ...
    param_r=[mean(Phatss_model1(:,1)) quantile(Phatss_model1(:,1),0.025) quantile(Phatss_model1(:,1),0.975)];
    param_p=[mean(Phatss_model1(:,2)) quantile(Phatss_model1(:,2),0.025) quantile(Phatss_model1(:,2),0.975)];

    param_a=[mean(Phatss_model1(:,3)) quantile(Phatss_model1(:,3),0.025) quantile(Phatss_model1(:,3),0.975)];
    param_K=[mean(Phatss_model1(:,4)) quantile(Phatss_model1(:,4),0.025) quantile(Phatss_model1(:,4),0.975)];

    param_I0=[mean(Phatss_model1(:,5)) quantile(Phatss_model1(:,5),0.025) quantile(Phatss_model1(:,5),0.975)];

    param_alpha=[mean(Phatss_model1(:,6)) quantile(Phatss_model1(:,6),0.025) quantile(Phatss_model1(:,6),0.975)];

    param_d=[mean(Phatss_model1(:,7)) quantile(Phatss_model1(:,7),0.025) quantile(Phatss_model1(:,7),0.975)];
